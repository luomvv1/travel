                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div id="wizard" class="form_wizard wizard_horizontal wizard-edit-tour">
                            ...
                            <div id="step-2">
                                <h2 class="StepTitle">Quản lý hình ảnh</h2>
                                @include('admin.partials.tour-images')
                            </div>
                            <div id="step-3">
                                <h2 class="StepTitle">Quản lý lịch khởi hành</h2>
                                @include('admin.partials.tour-schedules')
                            </div>
