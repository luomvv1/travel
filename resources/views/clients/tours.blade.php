                            ...
                            @foreach ($toursPopular as $tour)
                                <div class="destination-item tour-grid style-three bgc-lighter">
                                    <div class="image">
                                        ...
                                        @php
                                            $popularTourImage = collect($tour->images ?? [])->first();
                                        @endphp
                                        <img src="{{ $popularTourImage ? asset('admin/assets/images/gallery-tours/' . $popularTourImage) : asset('clients/assets/images/widgets/cta-widget.png') }}"
                                            alt="Tour">
                                    </div>
                                    <div class="content">
