    ...
    if ($("#myDropzone").length) {
        ...
        $(".add-tours #wizard .buttonNext").on("click", function (event) {
            ...
            if (currentStep === 2) {
                ...
                if (!tourId) {
                    toastr.error(
                        "Tour chưa được tạo ở bước 1. Vui lòng quay lại và thử lại."
                    );
                    return;
                }

                const totalFiles = myDropzone.files.length;
                const successfulFiles = myDropzone.getFilesWithStatus(
                    Dropzone.SUCCESS
                ).length;
                ...
                if (totalFiles >= 5) {
                    ...
                    } else if (successfulFiles >= 5) {
                        finishStep2 = true;
                        $(".add-tours #wizard").smartWizard("next");
                    } else {
                        toastr.error(
                            "Một số ảnh tải lỗi. Vui lòng xóa ảnh lỗi và tải lại."
                        );
                    }
                } else {
                    toastr.warning(
        ...
        myDropzone.on("queuecomplete", function () {
            ...
            if (successfulFiles >= 5) {
                ...
                finishStep2 = false;
                toastr.error(
                    "Một số ảnh tải thất bại. Vui lòng kiểm tra và tải lại ảnh lỗi."
                );
            }
        });
...
function init_echarts() {
    ...
    if ($("#echart_donut").length) {
        ...
        var paymentMethodNames = {
            ...
            "tai_van_phong": "Thanh toán tại văn phòng",
        };
    
        var paymentMethodColors = {
            "momo": "#FF0000",  
            "vnpay": "#0057B8", 
            "tai_van_phong": "#FFA500",
        };
